...
public class DeliveryScenarioFactory {
    ...
    public static DeliveryScenario createBasicScenario() {
        ...
        List<DeliveryOrder> orders = Arrays.asList(
            new DeliveryOrder("ORD001", r1, c1, 15, Priority.MEDIUM), // pt1 = 15 minutes, normal priority
            new DeliveryOrder("ORD002", r2, c2, 20, Priority.HIGH)  // pt2 = 20 minutes, high priority
        );
    ...
    public static DeliveryScenario createComplexScenario() {
        ...
        List<DeliveryOrder> orders = Arrays.asList(
            new DeliveryOrder("ORD001", r1, c1, 10, Priority.HIGH), // High priority, quick prep
            new DeliveryOrder("ORD002", r2, c2, 15, Priority.LOW), // Normal priority
            new DeliveryOrder("ORD003", r3, c3, 25, Priority.MEDIUM), // Medium priority, slow prep
            new DeliveryOrder("ORD004", r4, c4, 12, Priority.LOW)  // Normal priority
        );
    ...
    public static DeliveryScenario createEdgeCaseScenario() {
        ...
        List<DeliveryOrder> orders = Arrays.asList(
            new DeliveryOrder("ORD001", restaurant, c1, 5, Priority.LOW),  // Quick prep, near delivery
            new DeliveryOrder("ORD002", restaurant, c2, 30, Priority.LOW)  // Slow prep, far delivery
        );
    ...
    public static DeliveryScenario createPerformanceTestScenario() {
        ...
        DeliveryOrder[] orders = {
            new DeliveryOrder("ORD001", new Location("R1", "Restaurant 1", 12.9756, 77.5936),
                            new Location("C1", "Consumer 1", 12.9776, 77.5926), 10, Priority.LOW),
            new DeliveryOrder("ORD002", new Location("R2", "Restaurant 2", 12.9696, 77.5956),
                            new Location("C2", "Consumer 2", 12.9686, 77.5966), 15, Priority.MEDIUM),
            new DeliveryOrder("ORD003", new Location("R3", "Restaurant 3", 12.9736, 77.5976),
                            new Location("C3", "Consumer 3", 12.9796, 77.5906), 20, Priority.LOW),
            new DeliveryOrder("ORD004", new Location("R4", "Restaurant 4", 12.9676, 77.5916),
                            new Location("C4", "Consumer 4", 12.9656, 77.5986), 12, Priority.HIGH),
            new DeliveryOrder("ORD005", new Location("R5", "Restaurant 5", 12.9806, 77.5886),
                            new Location("C5", "Consumer 5", 12.9816, 77.5996), 18, Priority.LOW),
            new DeliveryOrder("ORD006", new Location("R6", "Restaurant 6", 12.9646, 77.6006),
                            new Location("C6", "Consumer 6", 12.9626, 77.5876), 25, Priority.MEDIUM)
        };
